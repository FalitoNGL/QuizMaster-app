...
<div class="max-w-3xl">
    <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-2xl font-bold mb-6">Tambah Soal untuk: {{ $quiz->title }}</h2>
        ...
        <form action="{{ route('admin.quizzes.questions.store', $quiz) }}" method="POST" 
            ...
            <div class="mb-4">
                ...
                <textarea name="content" rows="4" required
                          class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-indigo-500"
                          placeholder="Tulis pertanyaan di sini...">{{ old('content') }}</textarea>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 font-medium mb-2">Media (Gambar/Audio)</label>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="points" value="{{ old('points', 10) }}" 
            ...
            <div class="mb-6">
                ...
                <template x-for="(option, index) in options" :key="index">
                    <div class="flex gap-2 mb-2 items-center">
                        ...
                        <!-- Correct checkbox (not for ordering) -->
                        <template x-if="type !== 'ordering'">
...
function questionForm() {
    return {
        type: 'single_choice',
        options: [
            { text: '', is_correct: false, pair_text: '', order_sequence: 1 },
            { text: '', is_correct: false, pair_text: '', order_sequence: 2 },
        ],
        addOption() {
            this.options.push({ 
                text: '', 
